        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          {
            ...
            value: [
              ...
              "frame-src 'self' https://vidsrc.to https://vidsrc.cc https://vidsrc.pm https://vidsrcme.ru https://vidlink.pro https://www.2embed.cc https://multiembed.mov https://www.youtube.com https://embed.su https://player.autoembed.cc https://autoembed.cc https://vidnest.fun https://*.vidsrc.to https://*.vidsrc.cc https://*.vidsrc.pm https://*.vidsrcme.ru https://*.vidlink.pro https://*.2embed.cc https://*.multiembed.mov https://*.youtube.com https://*.embed.su https://*.autoembed.cc https://*.vidnest.fun",
              "media-src 'self' blob: https://*.vidsrc.to https://*.vidsrc.cc https://*.vidsrc.pm https://*.vidsrcme.ru https://*.vidlink.pro https://*.2embed.cc https://*.multiembed.mov https://*.youtube.com https://*.embed.su https://*.autoembed.cc https://*.vidnest.fun",
